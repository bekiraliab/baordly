...
import { Loader2, Plus, Rocket, Trello, ActivityIcon, Grid3x3, List, Filter, Search } from "lucide-react";
                ...
                <CardContent className="p-4 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl sm:text-2xl font-bols text-gray-900">{boards?.length}</p>
                    </div>
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl sm:text-2xl font-bols text-gray-900">{boards?.filter((board)=> {
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-gray-600">Manage your porjects and tasks</p>
          </div>
         ...
         <div className="relative mb-4 sm:mb-6">
           ...
           <Input id="search" placeholder="Search boards..."
           className="pl-10"
           />
         </div>
